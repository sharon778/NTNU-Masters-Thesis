...
In association with the log formats for the hippocampal and neocorical module experiments, I wrote a parser, which is specifically designed to parse the corresponding log-files and log-file data. This parser is connected to a plotting library which creates figures and plots of the different experiment results, such as the average convergence and recall rates by the neuronal neuronal turnover rate.
