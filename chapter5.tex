...
Through various experiments, a novel dual-network memory model is implemented, based upon \citep{Hattori2014}. It is attained through a novel model parametrization, using synchronous neuronal activation value propagation and synaptic modification, as well as all of the chaotically extracted patterns from the hippocampal model to the neocortical neural network. The novel hippocampal model is comparatively speaking significantly better in performance relative to the state-of-the-art in terms of perfect recall, particularly for hetero-associative patterns.
