...
Theano has an aggressive reuse of memory, which is largely what makes its code fast (cite webpage). Theano has its own memory space, which does not usually overlap with Python's.
