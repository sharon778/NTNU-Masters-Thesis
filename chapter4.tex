...
% \subsection{Distorted I/Os demo. - lossless using subset sequential training as baseline measure, but highly sensitive to number of training patterns, i.e. pseudopatterns}
...
Nevertheless, it is noteworthy that a greater number of patterns, acquired only by chaotical recall per subset, and trained on only as subsets, successfully leads the neocortical network to attain an equal or improved good goodness of fit, as well as a significant empirical reduction in catastrophic interference.
