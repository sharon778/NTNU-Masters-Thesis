...
% \begin{figure}
%     \centering
%     \includegraphics[width=14cm]{fig/neo-consolidation/consolidation-IO-span-all}
%     \caption{}
%     \label{fig:consolidation-IO-span-all}
% \end{figure}
...
2x5 contains far more spurious patterns! Figure:

\begin{figure}
    \centering
    \includegraphics[width=13cm]{fig/neo-consolidation/}
\end{figure}
